                ...
                ZStack {
                        ...
                        .background(
                            LinearGradient(
                                stops: [
                                    Gradient.Stop(
                                        color: Color(
                                            red: 0.37, green: 0.79, blue: 0.89
                                        ).opacity(0.5), location: 0.00),
                                    Gradient.Stop(
                                        color: Color(
                                            red: 0.48, green: 0.9, blue: 1),
                                        location: 1.00),
                                ],
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        HStack(spacing: 0) {
                            Rectangle()
                                .foregroundColor(
                                    Color(red: 0.01, green: 0.7, blue: 0.86)
                                )
                    ...
                    ZStack {
                                    ...
                                    stops: [
                                        Gradient.Stop(
                                            color: Color(
                                                red: 0.01, green: 0.71,
                                                blue: 0.02
                                            ).opacity(0.3), location: 0.00),
                                        Gradient.Stop(
                                            color: Color(
                                                red: 0.55, green: 0.95,
                                                blue: 0.56
                                            ).opacity(0.3), location: 1.00),
                                    ],
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Text("Peso")
                                ...
                                .foregroundColor(
                                    Color(red: 0.01, green: 0.71, blue: 0.02))
                        }
                    }
                    .padding(.bottom, 26)
                    ...
                    ZStack {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Text("Tamaño")
                                ...
                                .foregroundColor(
                                    Color(red: 0.96, green: 0.73, blue: 0.02))
                        }
                ...
                ForEach(monthDays, id: \.self) { day in
                    ...
                    VStack {
                        Text("\(day)")
                            .frame(width: 60, height: 60)
                            .background(
                                isToday ? Color.black : Color.gray.opacity(0.2)
                            )
                            .foregroundColor(
